...
public:
    ...
    void retranslateUi(QWidget *StakeForCharityDialog)
    {
        ...
        label_12->setText(QApplication::translate("StakeForCharityDialog", "MultiSend allows you to automatically send up to 100% of your Stake to a list of other PayCon address after it matures.\n"
"To Add: enter percentage to give and PayCon address to add to the MultiSend vector. \n"
