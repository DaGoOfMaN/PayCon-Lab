...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Wed Aug 1 14:59:29 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode -lminiupnpc /home/user/LAB/PayCon/src/leveldb/libleveldb.a /home/user/LAB/PayCon/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -levent -lz -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/user/LAB/PayCon/src/leveldb/libleveldb.a; cd /home/user/LAB/PayCon/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/user/LAB/PayCon/src/leveldb/libleveldb.a: FORCE
	cd /home/user/LAB/PayCon/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/user/LAB/PayCon/build/build.h: FORCE
	cd /home/user/LAB/PayCon; /bin/sh share/genbuild.sh /home/user/LAB/PayCon/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/skype_icon_64.png \
		...
		src/qt/res/icons/PayCon.png \
		src/qt/res/icons/Twitter-icon-64.png \
