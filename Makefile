#############################################################################
# Makefile for building: PayCon-qt
<<<<<<< HEAD
# Generated by qmake (2.01a) (Qt 4.8.7) on: Tue Aug 7 18:27:34 2018
=======
# Generated by qmake (2.01a) (Qt 4.8.7) on: Tue Aug 7 17:12:25 2018
>>>>>>> aecba0558d4f016173f435a3c8fbc40e3dd4e75a
# Project:  paycon-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile paycon-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DBOOST_SPIRIT_THREADSAFE -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DSTATIC -DQT_STATIC_BUILD -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -I/usr/local/include -Isrc/tor -Isrc/lz4 -Isrc/leveldb/include -Isrc/leveldb/helpers -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode -lminiupnpc /home/user/.local/share/Trash/files/PayCon-Lab/src/leveldb/libleveldb.a /home/user/.local/share/Trash/files/PayCon-Lab/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -levent -lz -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: paycon-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Makefile paycon-qt.pro
...
/home/user/.local/share/Trash/files/PayCon-Lab/src/leveldb/libleveldb.a: FORCE
	cd /home/user/.local/share/Trash/files/PayCon-Lab/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/user/.local/share/Trash/files/PayCon-Lab/build/build.h: FORCE
	cd /home/user/.local/share/Trash/files/PayCon-Lab; /bin/sh share/genbuild.sh /home/user/.local/share/Trash/files/PayCon-Lab/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/PayCon-Yuno.png \
		src/qt/res/icons/export.png \
		src/qt/res/icons/yobit.png \
		src/qt/res/icons/forums.png \
		src/qt/res/icons/PayCon256.png \
		...
		src/qt/res/icons/PayCon-16.png \
		src/qt/res/icons/stats.png \
		src/qt/res/icons/PayCon.png \
