...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Aug 26 05:49:30 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode -lminiupnpc /home/user/-lab/PayCon-Lab/src/leveldb/libleveldb.a /home/user/-lab/PayCon-Lab/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -levent -lz -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/user/-lab/PayCon-Lab/src/leveldb/libleveldb.a; cd /home/user/-lab/PayCon-Lab/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/user/-lab/PayCon-Lab/src/leveldb/libleveldb.a: FORCE
	cd /home/user/-lab/PayCon-Lab/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/user/-lab/PayCon-Lab/build/build.h: FORCE
	cd /home/user/-lab/PayCon-Lab; /bin/sh share/genbuild.sh /home/user/-lab/PayCon-Lab/build/build.h
